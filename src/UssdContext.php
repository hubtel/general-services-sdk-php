...
class UssdContext
{
    ...
    function sessionExecuteAction()
    {
        ...
        if (!$controllerClass->isSubclassOf('HubtelUssdFramework\UssdController')) {
            trigger_error(sprintf(
                'Class \"%s\" does not '
                    . 'subclass "HubtelUssdFramework\UssdController"',
                $controllerClass
            ));
        }
        ...
        // $response->setSessionId($this->_request->get());
        ...
        if (!($response instanceof UssdResponse)) {
            throw new FrameworkException(sprintf(
                ...
                $controllerClass->getName(),
                $actionName,
                'HubtelUssdFramework\UssdResponse',
