...
class UssdRequest
{
    ...
    function getSessionId()
    {
        ...
        // if ($this->_sessionId == "" && strtolower($this->getType()) == strtolower(self::REQUEST_TYPE_INITIATION)) {
        //     $this->setSessionId($this->generateSessionId());
        // } else if (strtolower($this->getType()) == strtolower(self::REQUEST_TYPE_RESPONSE) && $this->_sessionId  == "") {
        //     throw new \InvalidArgumentException('sessionId argument '
        //         . 'cannot be null');
        // }
